  ...
  return (
    <Container
      ...
      sx={{
        ...
        px: { xs: 2, sm: 3 },
        fontFamily: "inherit",
        "& .MuiTypography-root, & .MuiButton-root, & .MuiInputBase-root, & .MuiInputBase-input, & .MuiInputLabel-root, & .MuiFormControlLabel-label, & .MuiMenuItem-root, & .MuiChip-label, & .MuiAlert-message": {
